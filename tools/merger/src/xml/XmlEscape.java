 ...
 *       needs of the scenario). Its values are defined by the {@link XmlEscapeLevel}
 *       enum.</li>
 ...
 *       Its values are defined by the {@link XmlEscapeType} enum.</li>
 * </ul>
 * <p>
...
public final class XmlEscape {
     ...
     * <ul>
     *   <li><tt>type</tt>:
     *       {@link XmlEscapeType#CHARACTER_ENTITY_REFERENCES_DEFAULT_TO_HEXA}</li>
     *   <li><tt>level</tt>:
     *       {@link XmlEscapeLevel#LEVEL_1_ONLY_MARKUP_SIGNIFICANT}</li>
     * </ul>
     * <p>
     ...
     *       {@link XmlEscapeType#CHARACTER_ENTITY_REFERENCES_DEFAULT_TO_HEXA}</li>
     *   <li><tt>level</tt>:
     *       {@link XmlEscapeLevel#LEVEL_2_ALL_NON_ASCII_PLUS_MARKUP_SIGNIFICANT}</li>
     * </ul>
     * <p>
     *   This method is <strong>thread-safe</strong>.
     * </p>
     ...
     *   {@link XmlEscapeType} and {@link XmlEscapeLevel}
     *   argument values.
     * </p>
     * <p>
     ...
     *
     * @param text the <tt>String</tt> to be escaped.
     * @param type the type of escape operation to be performed, see {@link XmlEscapeType}.
     * @param level the escape level to be applied, see {@link XmlEscapeLevel}.
     * @return The escaped result <tt>String</tt>. As a memory-performance improvement, will return the exact
     *         same object as the <tt>text</tt> input argument if no escaping modifications were required (and
     *         no additional <tt>String</tt> objects will be created during processing). Will
     *         return <tt>null</tt> if input is <tt>null</tt>.
